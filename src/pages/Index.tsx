            ...
            <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[216px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full">
              <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <div className="self-stretch rounded-[3px] flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                  <div className="w-full max-w-[748.71px] lg:w-[748.71px] text-center flex justify-center flex-col text-[#37322F] text-[24px] sm:text-[36px] md:text-[52px] lg:text-[80px] font-normal leading-[1.1] sm:leading-[1.15] md:leading-[1.2] lg:leading-[96px] font-serif px-2 sm:px-4 md:px-0">
                    Эмоции в каждом лепестке 🌸
                  </div>
                  <div className="w-full max-w-[506.08px] lg:w-[506.08px] text-center flex justify-center flex-col text-[rgba(55,50,47,0.80)] sm:text-lg md:text-xl leading-[1.4] sm:leading-[1.45] md:leading-[1.5] lg:leading-7 font-sans px-2 sm:px-4 md:px-0 lg:text-lg font-medium text-sm">
                    Цветы, свечи и подарочные наборы
                    <br className="hidden sm:block" />
                    для любого момента жизни — магазин «ВерАлекс».
                  </div>
                </div>
              </div>
                  ...
                  <div className="self-stretch flex-1 flex justify-start items-start">
                    <div className="w-full h-full flex items-center justify-center">
                      <div className="relative w-full h-full overflow-hidden">
                        ...
                        >
                          <img
                            src="https://cdn.poehali.dev/projects/8e3ccb4b-8c5c-4599-83a2-5226564d5eef/files/82944ff3-98b6-4ecf-8619-e7c92afe8c42.jpg"
                            alt="Букеты цветов"
                        ...
                        >
                          <img
                            src="https://cdn.poehali.dev/projects/8e3ccb4b-8c5c-4599-83a2-5226564d5eef/files/15933de7-d9e4-47eb-84ef-a97d1cbdad79.jpg"
                        ...
                        >
                          <img
                            src="https://cdn.poehali.dev/projects/8e3ccb4b-8c5c-4599-83a2-5226564d5eef/files/d7a19ae6-519f-4174-bb53-64efa2336084.jpg"
                            alt="Воздушные шары"
                            className="w-full h-full object-cover"
                          />
                        </div>
              ...
              <div className="self-stretch border-t border-[#E0DEDB] border-b border-[#E0DEDB] flex justify-center items-start">
                ...
                <div className="flex-1 px-0 sm:px-2 md:px-0 flex flex-col md:flex-row justify-center items-stretch gap-0">
                  <FeatureCard
                    title="Свежие цветы"
                    description="Розы, лилии, герберы — отбираем каждый цветок вручную. Идеально для признаний и поздравлений."
                  ...
                  <FeatureCard
                    ...
                    description="Нотки ванили, свежесть леса, классический воск — создайте уют и тепло в вашем доме."
                  ...
                  <FeatureCard
                    ...
                    description="Латексные и фольгированные, цифры и буквы — оформим праздник так, чтобы улыбки не сходили."
                ...
                <div className="self-stretch px-4 sm:px-6 md:px-24 py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[586px] px-4 sm:px-6 py-4 sm:py-5 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4">
                    ...
                    <div className="w-full max-w-[472.55px] text-center flex justify-center flex-col text-[#49423D] text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold leading-tight md:leading-[60px] font-sans tracking-tight">
                      Нам доверяют тысячи покупателей
                    </div>
                    <div className="self-stretch text-center text-[#605A57] text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Каждый цветок мы отбираем вручную.
                      <br className="hidden sm:block" />
                      Каждую свечу проверяем на качество. С любовью к деталям.
                    </div>
                  </div>
                </div>
                ...
                <div className="self-stretch px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[616px] lg:w-[616px] px-4 sm:px-6 py-4 sm:py-5 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4">
                    ...
                    <div className="w-full max-w-[598.06px] lg:w-[598.06px] text-center flex justify-center flex-col text-[#49423D] text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold leading-tight md:leading-[60px] font-sans tracking-tight">
                      Всё для праздника в одном месте
                    </div>
                    <div className="self-stretch text-center text-[#605A57] text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Цветы, свечи, шары и подарочные наборы —
                      <br />
                      создайте незабываемый момент с «ВерАлекс».
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-0 border-l border-r border-[rgba(55,50,47,0.12)]">
                    <div className="border-b border-r-0 md:border-r border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          «Романтика», «Детский восторг», «Уютный вечер» — мы собрали всё за вас, продуманно до мелочей.
                        </p>
                      </div>
                    ...
                    <div className="border-b border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Закажите доставку прямо к двери или заберите самовывозом — удобно и быстро для любого случая.
                        </p>
                      </div>
                    ...
                    <div className="border-r-0 md:border-r border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6 bg-transparent">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Не знаете, что подарить? Наши флористы помогут выбрать те самые цветы, которые скажут всё за вас.
                        </p>
                      </div>
                    ...
                    <div className="p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Регулярные поставки цветов, новые коллекции свечей и сезонные новинки — всегда есть что-то особенное.
                        </p>
                      </div>
